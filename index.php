...
<body>
    ...
    <header>
        ...
        <section class="navsection">
            ...
            <nav>
                ...
                <a href="create_account.php"><span>CREATE ACCOUNT</span></a>
    ...
    <div class="wrapper">
        ...
        <a class="crea-account" id="spam" href="">GET STARTED — IT‘S FREE!</a>
        <div class="moviebox">
        ...
        <section class="recentshowdowns">
            ...
            <section class="sectionews">
                ...
                <div class="newsblock">
                    ...
                    <p>Anyone But You director Will Gluck on sleeper hits, Shakespeare and making sex symbols do silly
                        things.
                    </p>
                </div>
                <div class="newsblock">
